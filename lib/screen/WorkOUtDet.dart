                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                      image: DecorationImage(
                          fit: BoxFit.cover,
                          image: NetworkImage('https://images.bhaskarassets.com/web2images/521/2020/10/06/yo11_1601975331.gif')

                      )
                  ),
                ),
                SizedBox(height: 20,),
                Text('Anulom Vilom',style: TextStyle(fontWeight:FontWeight.w600,fontSize: 30),),
                Container(
